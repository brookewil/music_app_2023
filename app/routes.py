...
e1 = Events(title="Sneaking Out of Heaven TOUR", date=datetime(2024,3,11,7, 0), venue_id=v3)
e2 = Events(title="Dawn to Dusk TOUR", date=datetime(2023, 10, 18, 8, 30), venues=v2)
e3 = Events(title="Dawn to Dusk TOUR", date=datetime(2023, 10, 20, 8), venues=v3)
e4 = Events(title="Dawn to Dusk TOUR", date=datetime(2023,10,22,8), venues=v4)
e5 = Events(title="The Jaws of Life TOUR", date=datetime(2023, 11, 7, 6, 30), venues=v5)
e6 = Events(title="Sneaking Out of Heaven TOUR", date=datetime(2024, 4, 1, 8, 30), venues=v5)
